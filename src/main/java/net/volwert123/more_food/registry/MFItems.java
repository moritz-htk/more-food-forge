...
public class MFItems {
    ...
    public static final RegistryObject<Item> COOKED_PUFFERFISH = ITEMS.register("cooked_pufferfish",() -> new Item(new Item.Properties().food(registerFoodValues(5, 2.5f))));
